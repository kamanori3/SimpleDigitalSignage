...
/// <summary>
/// キオスク画面（全画面表示）の code-behind。
/// <para>
/// 責務は View 寄り:
/// キオスク枠の ON/OFF、管理モード切替、日次スケジュールの購読、
...
public partial class MainWindow : Window
{
  ...
  /// <summary>true のあいだはキオスクを隠し、管理画面を前面にする。</summary>
  ...
  /// <summary>
  /// 初回表示時にキオスクを有効化し、日次スケジュール監視を開始する。
  /// </summary>
  ...
  /// <summary>Ctrl+Shift+M で管理モードとキオスクを切り替える。</summary>
  ...
  /// キオスク再生中には出さない。既読管理はせず、開くたびに再表示する。
  /// </summary>
